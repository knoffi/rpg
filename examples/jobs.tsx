...
const prostituteJobs={necessary:[a.prostitute], nested:[ new Substantive("Mistress",[a.underdark,a.drow,a.human,a.city,a.haven,a.worker],s.job),
new Substantive("Domina",[a.gnome,a.human,a.city,a.sophisticated,a.drow],s.job),
new Substantive("Wench",[a.village,a.halfling,a.haven,a.dwarf,a.poor],s.job), 
new Substantive("Cowgirl",[a.village,a.mountain,a.haven,a.halfling],s.job), 
new Substantive("Milkmaid",[a.village,a.mountain,a.haven,a.halfling],s.job), 
new Substantive("Maiden",[a.bard,a.sophisticated,a.nobel,a.elf,a.worker],s.job), 
new Substantive("Harlot",[a.city,a.sophisticated,a.elf,a.criminal,a.poor],s.job), 
...
export const jobs = getDividedProducts(dividableJobs).concat(makeProductsFromNecessary(prostituteJobs))
