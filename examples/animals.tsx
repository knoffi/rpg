...
const dividableAnimals=[new Substantive("Pheasant", [a.druid, a.nobel, a.forest, a.rich], s.animal),
new Substantive(
  "Guinea Fowl",
...
const prostituteAnimals = {necessary:[a.prostitute], nested:[
  new Substantive("Mermaid", [a.adventurer, a.haven], s.animal),
  new Substantive("Nymph", [a.adventurer, a.bard ], s.animal),
  new Substantive("Satyr", [a.adventurer, a.bard ], s.animal),
...
export const animals=getDividedProducts(dividableAnimals).concat(makeProductsFromNecessary(prostituteAnimals));
