...
export const AssociationPickerBar = (props: {
    fits: association[];
    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            <AssociationPicker
                isClickable={!pickersOpen}
                pickAssociationList={landAssociations}
                startText={'LAND'}
                onPick={(
            ...
            <AssociationPicker
                isClickable={!pickersOpen}
                pickAssociationList={incomeAssociations}
                startText={'INCOME'}
                onPick={(
                    oldAssociation: association,
                    newAssociation: association
            ...
            <AssociationPicker
                isClickable={!pickersOpen}
                pickAssociationList={classAssociations}
                startText={'CLASS'}
                onPick={(
                    oldAssociation: association,
                    newAssociation: association
            ...
            <AssociationPicker
                isClickable={!pickersOpen}
                pickAssociationList={raceAssociations}
                startText={'RACE'}
                onPick={(
                    oldAssociation: association,
                    newAssociation: association
            ...
            <AssociationPicker
                isClickable={!pickersOpen}
                pickAssociationList={specialAssociations}
                startText={'SPECIALS'}
                onPick={(
                    oldAssociation: association,
                    newAssociation: association
