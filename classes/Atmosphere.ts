...
const bartenderAppearances = [
    ...
    { association: a.wealthy, name: 'Elegant', unfitting: lowerClass },
...
const bartenderCharacter = [
    ...
    { association: a.modest, name: 'Vulgar', unfitting: upperClass },
    ...
    { association: a.wealthy, name: 'Organized' },
    { association: a.empty, name: 'Organized' },
    { association: a.modest, name: 'Hard-Working' },
    { association: a.knight, name: 'Nobel', unfitting: lowerClass },
    { association: a.knight, name: 'Brave' },
    { association: a.cleric, name: 'Enlightened' },
    { association: a.cleric, name: 'Kind' },
    { association: a.thief, name: 'Shady' },
    { association: a.thief, name: 'Dangerous' },
    { association: a.thief, name: 'Parrot Pet' },
    ...
    { association: a.soldier, name: 'Fierce' },
    { association: a.soldier, name: 'Crude Humor' },
...
const somePeople = [
    { association: a.thief, name: 'Whispering' },
    ...
    { association: a.soldier, name: 'Bragging' },
    ...
    { association: a.thief, name: 'Grumbling' },
    { association: a.thief, name: 'Smoking' },
    { association: a.thief, name: 'Betting' },
    ...
    { association: a.assasine, name: 'Spying' },
    { association: a.empty, name: 'Spying' },
    ...
    { association: a.modest, name: 'Slurring' },
...
const individuals = [
    ...
    { association: a.wealthy, name: 'A Baron', unfitting: lowerClass },
    { association: a.wealthy, name: 'A Judge', unfitting: lowerClass },
    { association: a.wealthy, name: 'A Doctor', unfitting: lowerClass },
    { association: a.wealthy, name: 'A Baroness', unfitting: lowerClass },
    ...
    { association: a.soldier, name: 'A Soldier', unfitting: upperClass },
    ...
    { association: a.soldier, name: 'An Archer', unfitting: upperClass },
    ...
    { association: a.wealthy, name: 'A Sculptor', unfitting: lowerClass },
    { association: a.gnome, name: 'A Sculptor', unfitting: lowerClass },
    ...
    { association: a.wealthy, name: 'A Jeweler', unfitting: lowerClass },
    ...
    { association: a.wealthy, name: 'A Bishop', unfitting: lowerClass },
    ...
    { association: a.knight, name: 'A Cavalier' },
    ...
    { association: a.modest, name: 'A Scholar' },
    ...
    { association: a.knight, name: 'A Knight' },
    ...
    { association: a.modest, name: 'A Potter', unfitting: upperClass },
    { association: a.modest, name: 'A Carpenter', unfitting: upperClass },
