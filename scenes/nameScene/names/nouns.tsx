...
const dividableAdjectives = [
    ...
    new Adjective('Copper', [a.sophisticated, a.adventurer], empty),
    new Adjective('Bronze', [a.worker, a.bard], empty),
    new Adjective('Tin', [a.worker, a.cleric], empty),
    new Adjective('Brass', [a.worker, a.wizard], empty),
